...
describe("isOnOrBefore", () => {
  it("true, gdy a jest wcześniej", () => {
    expect(isOnOrBefore(isoDate("2026-01-01"), isoDate("2026-01-02"))).toBe(true);
  });

  it("true, gdy a i b są równe", () => {
    expect(isOnOrBefore(isoDate("2026-01-01"), isoDate("2026-01-01"))).toBe(true);
  });

  it("false, gdy a jest później", () => {
    expect(isOnOrBefore(isoDate("2026-01-02"), isoDate("2026-01-01"))).toBe(false);
  });
});
